...
const profile = {
  ...
  researchInterestsHtml: "I'm interested in generative foundation models that can both understand and generate across modalities. Much of my work has been on multimodal representation learning and generative modeling with diffusion and flow matching, and more recently on aligning large generative models to user preferences through reinforcement learning and reward modeling. I also work on discrete representation learning and semantic tokenization to build foundation models for domains that lack them, representing media, items, and users in one shared space — which I've applied to personalization at scale to improve user engagement. Throughout, I care about making these models robust and trustworthy, through adversarial robustness, machine unlearning, and efficient training at scale.",
