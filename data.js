...
const profile = {
  ...
  researchInterestsHtml: "My research spans the following directions. (1) I work on <b>generative foundation models</b> that can both understand and generate across modalities — much of this has been on <b>multimodal representation learning</b> and generative modeling with <b>diffusion</b> and <b>flow matching</b>, and more recently on aligning large generative models to user preferences through <b>reinforcement learning</b> and <b>reward modeling</b>. (2) <b>Personalization and Recommendation at scale</b>, where I build generative recommenders that model user preferences to improve engagement for tens of millions of users. (3) I also work on discrete representation learning and tokenization to <b>build foundation models for new domains with new vocabularies</b>. (4) Throughout, I care about making these <b>models robust and trustworthy</b>, through adversarial robustness, machine unlearning, and efficient training at scale.",
