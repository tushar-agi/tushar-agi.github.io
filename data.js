...
const profile = {
  ...
  researchInterestsHtml: "I'm interested in <b>generative foundation models</b> that can both understand and generate across modalities. Much of my work has been on <b>multimodal representation learning</b> and <b>generative modeling</b> with <b>diffusion</b> and <b>flow matching</b>, and more recently on <b>aligning large generative models to user preferences</b> through <b>reinforcement learning</b> and <b>reward modeling</b>. I also work on <b>discrete representation learning</b> and <b>semantic tokenization</b> to build foundation models for domains that lack them, representing media, items, and users in one shared space — which I've applied to <b>personalization at scale</b> to improve user engagement. Throughout, I care about making these models robust and trustworthy, through <b>adversarial robustness</b>, <b>machine unlearning</b>, and <b>efficient training at scale</b>.",
